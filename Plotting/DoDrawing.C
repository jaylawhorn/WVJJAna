...
void DoDrawing() {
  ...
  Draw2(VBF_EWK,bins,"VBF_EWK_2017loose_drawM.root","nom");
  Draw2(VBF_QCD,bins,"VBF_QCD_2017loose_drawM.root","nom");
  Draw2(Top,bins,"Top_2017loose_drawM.root","nom");
  Draw2(WJets,bins,"WJets_2017loose_drawM.root","nom");
  Draw2(DYJets,bins,"DYJets_2017loose_drawM.root","nom");
